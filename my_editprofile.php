                ...
                <div id="form2">
                    ...
                    <form action="" method="post" id="f" class="ff" enctype="multipart/form-data" style="float-text:left">
                        ...
                        <table>
                            ...
                            <tr>
                                <td style="align-content: right">Photo:</td>
                            ...
                            <tr>
                                <td style="align-content: right">First Name:</td>
                            ...
                            <tr>
                                <td style="align-content: right">Last Name:</td>
                            ...
                            <tr>
                                <td style="align-content: right">Email:</td>
                            ...
                            <tr>
                                <td style="align-content: right">Password:</td>
