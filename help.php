...
<body>
  ...
  <h1 style="align-content: center"><b>Need some help ??</b></h1>
  <div class="container ">
        ...
        <div id="question5" class="panel-collapse collapse" style="height: 0px;">
          <div class="panel-body">
            <h4><span class="label label-primary">Answer</span>
              ...
              <p><br>Our textarea is made with summernote. This allows you to post all kinds of messages that include photos, URL's and codes in a pretty formatted way. </p>
            </h4>
          </div>
        </div>
      </div>
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDpJltk7G4M2douCfM_AdNzJvrHKyZh2uE&callback=initMap">
    </script>
  </div>
</body>
