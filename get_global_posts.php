<?php
   ...
   $per_page=5;
    ...
    $start_from= ($page-1) * $per_page; $connection=mysqli_connect("localhost","admin","monarchs","pet_finder") or die("Connection Failed");
     ...
     $user_posts= "select topics.topic_title,posts.topic_id,posts.post_id,posts.post_title,posts.post_content from posts,topics where posts.topic_id = topics.topic_id and global is not NULL order by post_date DESC LIMIT $start_from,$per_page
     ";
